<template>
      <TransitionRoot as="template" :show="open">
            <Dialog class="relative z-10" @close="navigateDrawer">
                                                                  ...
                                                                  <div
                                                                        ...
                                                                        <div>
                                                                              <label for="project-name"
                                                                                    class="block text-sm/6 font-medium text-gray-900 sm:mt-1.5">Meeting
                                                                                    name</label>
                                                                        </div>
                                                      ...
                                                      <div
                                                            ...
                                                            <div class="flex justify-end space-x-3">
                                                                  <button type="button"
                                                                        ...
                                                                        @click="navigateDrawer">Cancel</button>
                                                                  <button type="submit"
                                                                        class="inline-flex justify-center rounded-md bg-red-900 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600">Book</button>
                                                            </div>
                                                      </div>
                                                </form>
                                          </DialogPanel>
