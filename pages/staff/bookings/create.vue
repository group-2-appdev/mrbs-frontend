            ...
            <div
                  ...
                  <div class="min-w-0 flex-1">
                        <h1 class="flex gap-x-3 text-base leading-7">
                              ...
                              <NuxtLink to="/staff/bookings" class="hover:text-n3c-900 font-semibold text-gray-700">
                                    Bookings</NuxtLink>
                              <span class="text-gray-600">/</span>
                              
                              <span class="font-semibold text-gray-700">Book</span>
                        </h1>
                  </div>
            </div>
                  ...
                  <form class="space-y-8 w-full max-w-lg">
                        <div class="flex items-center justify-between">
                              ...
                              <button type="button" @click="openDrawer"
                                    class="ml-2 inline-flex items-center justify-center rounded-md bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-green-500">
                                    Book this room
                              </button>
                        </div>
...
const openDrawer = () => {
      bookDrawer.value.navigateDrawer()
}
</script>