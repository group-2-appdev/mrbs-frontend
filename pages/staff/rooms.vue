            ...
            <div
                  ...
                  <div class="min-w-0 flex-1">
                        <h1 class="flex gap-x-3 text-base leading-7">
                              <NuxtLink to="/staff/home" class="hover:text-n3c-900 font-semibold text-gray-700">
                                    Home</NuxtLink>
                  ...
                  <form class="space-y-8 w-full max-w-lg">
                        <div class="flex items-center justify-between">
                              ...
                              <div>
                                    <button type="button"
                                          @click="openDrawer"
                                          class="inline-flex items-center justify-center rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500">
                                          Edit Booking
                                    </button>
                                    <NuxtLink to="#"
                                          class="ml-2 inline-flex items-center justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-red-500">
                                          Cancel Booking
                                    </NuxtLink>
                              </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-y-6">
                              <div>
                                    <label for="name" class="block text-sm font-medium text-gray-900">Your
                                          Meeting Name</label>
                                    <span class="text-green-600 text-md">{{ form.meeting_name }}</span>
                              </div>

                              <div>
                                    <label for="name" class="block text-sm font-medium text-gray-900">Your Meeting Description</label>
                                    <span class="text-green-600 text-md">{{ form.meeting_description }}</span>
                              </div>

                              <div>
                                    <label for="name" class="block text-sm font-medium text-gray-900">Your Latest
                                          Booking Date & Period</label>
                                    <span class="text-green-600 text-md">{{ form.booking }}</span>
                              </div>
                              ...
                              <div>
                                    ...
                                    <span :class="{
                                          ...
                                          'text-green-700 ring-green-600/20 bg-green-50': form.status === 'Active',
...
let form = reactive({
      name: 'Meeting Room 1',
      total_pax: '30',
      meeting_name: 'Meeting with Petronas',
      meeting_description: 'To discuss a project about blockchain',
...
const openDrawer = () => {
      editDrawer.value.navigateDrawer()
}
</script>